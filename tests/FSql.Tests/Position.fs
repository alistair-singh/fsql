...
module Position = 
  ...
  [<Test>]
  let ``Position: initial position with source file correct``() =
    let expected = 
      { name = Some "TestFile" 
        line = 1
        column = 1
  ...
  [<Test>]
  let ``Position: update position normal character column increment``() =
    let expected = 
      { name = None
        line = 1
        column = 2
  ...
  [<Test>]
  let ``Position: update position '\r' character absolute increment``() =
    let expected = 
      { name = None
        line = 1
        column = 1
  ...
  [<Test>]
  let ``Position: update position "" string return same value``() =
    let expected = 
      { name = None
        line = 4
        column = 1
  ...
  [<Test>]
  let ``Position: update position "abc\r\nabc\nab" string return valid position``() =
    let expected = 
      { name = None
        line = 3
        column = 3
